...
Material_detail.rows[0].LOT_NUMBER = Material_detail.rows[0].LOT_NUMBER + "," + WorkOrders.rows[0].WORK_ORDER_CODE + "," + Alloys.rows[0].ALLOYS_CODE + "," + Alloys.rows[0].ALLOYS_NAME
let a = 0;
for (let i = 0; i < 9; i++) {
